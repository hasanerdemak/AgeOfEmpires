...
public class GameColors {
    // Player Colors
    public static final Color PLAYER1_COLOR = new Color(255, 100, 100); // Light Red
    public static final Color PLAYER2_COLOR = new Color(100, 100, 255); // Light Blue
    public static final Color PLAYER3_COLOR = new Color(100, 255, 100); // Light Green
    ...
    public static final Color LINE_TILE_COLOR = Color.BLACK;
}
